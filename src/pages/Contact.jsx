          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://instagram.com/homebuddy" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700">
                ...
                <a href="https://facebook.com/homebuddy" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700">
